  ...
  <div class="fill_content">
    <div class="module_tree">
      ...
      >
        ...
        <el-table-column prop="name" label="权限模块名称" width="140">
        </el-table-column>
  ...
  methods: {
    ...
    handleAclEdit(index, row) {
      ...
      this.add_acl = {
        ...
        name: row.name,
        url: row.url,
        //String()和toString()都是将其他类型的变量转换为字符串类型。toString()无法转换null和undefined
      ...
      for (let i = 0; i < tree.length; i++) {
        ...
        if (module.hasOwnProperty('aclModuleList')) {
          if (module.aclModuleList) {
            ...
            this.searchModuleTree(aclModuleId, module.aclModuleList)
          }
        }
      }
    }, */
    ...
    getModuleName(aclModuleId) {
      return this.searchModuleTree(aclModuleId, this.aclModuleList)
    },
  },
  components: {
    ModuleDialog,
